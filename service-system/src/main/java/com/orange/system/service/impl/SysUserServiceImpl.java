...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
     ...
     **/
    @Override
    public IPage<SysUser> selectPage(Page<SysUser> page, SysUserQueryVo roleQueryVo) {
        return sysUserMapper.selectPage(page,roleQueryVo);
    }
    ...
    public Map<String, Object> getUserInfo(String username) {
        ...
        //根据用户id获取菜单权限值
        List<RouterVo> routerVoList = sysMenuService.findUserMenuList(Long.parseLong(sysUser.getId()));
        //根据用户id获取用户按钮权限
        List<String> permsList = sysMenuService.findUserPermsList(Long.parseLong(sysUser.getId()));
